...
class ThemeHouse_FuturePerm_Deferred_FuturePermission extends XenForo_Deferred_Abstract
{
    ...
    public function execute(array $deferred, array $data, $targetRunTime, &$status)
    {
        ...
        $result = $permissionModel->rebuildFuturePermissionCache($targetRunTime, $data['startCombinationId']);
        if ($result === true) {
            return false;
        } else {
